        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-text-muted leading-relaxed mb-4">
              Web Developer with 5+ years building fast, SEO-optimised websites for clients in Thailand, Australia, and the UK. I specialise in WordPress, React, and Next.js — from design to e-commerce, custom plugins, and analytics.
            </p>
            <p className="text-text-muted leading-relaxed mb-4">
            ...
            <p className="text-text-muted leading-relaxed mb-8">
              I use AI tools (Claude, GitHub Copilot) to sharpen my workflow — faster research, cleaner code reviews, and quicker iteration — while keeping the engineering decisions mine.
            </p>
