...
export const allProjects: Project[] = [
  ...
  { slug: 'grind', title: 'Grind @ The Rise', shortDescription: 'Specialty café website with pixel-perfect brand translation.', tags: ['WordPress', 'Elementor', 'CDN'], coverImage: '/image/projects/grind-prod-hero.jpg', hasCaseStudy: true },
  { slug: 'birdhouse', title: 'Birdhouse Media', shortDescription: 'Video production agency site with CPT architecture and video team cards.', tags: ['WordPress', 'Custom Post Types', 'Elementor'], coverImage: '/image/projects/birdhouse-prod-hero.jpg', hasCaseStudy: true },
  { slug: 'newstart', title: 'Newstart Homes', shortDescription: 'Custom home builder site with filterable house-design catalogue.', tags: ['WordPress', 'Custom Post Types', 'NitroPack'], coverImage: '/image/projects/newstart-prod-hero.jpg', hasCaseStudy: true },
]
